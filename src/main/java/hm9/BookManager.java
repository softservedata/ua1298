...
public class BookManager {
    ...
    public List<String> printListOfAuthors() {
        return books.stream()
                .map(Book::getAuthor)
                .distinct()
    ...
    public List<String> listAuthorsByPublicationYear(int publicationYear){
        if (publicationYear <= 0) throw new IllegalArgumentException("Publication Year cannot be 0 or minus");
        return books.stream()
